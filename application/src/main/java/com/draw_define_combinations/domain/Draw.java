...
public class Draw implements Comparable<Draw> {
     ...
     */
    public Draw(String date, Short drawTypeId, TNumberList numbers, int complementary) {
    ...
    public Draw(TDateInteger date, Short drawTypeId, TNumberList numbers, int complementary) {
        this.drawDate = date;
        this.drawTypeId = drawTypeId;
        drawNumbers = new NumberCombination(numbers, complementary);
    }
